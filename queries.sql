...
UPDATE PATIENTS SET ALLERGIES='peanut' WHERE P_ID=1;
UPDATE PATIENTS SET ALLERGIES='shellfish' WHERE P_ID=3;
UPDATE PATIENTS SET ALLERGIES='latex' WHERE P_ID=5;
SELECT * FROM PATIENTS;

CREATE VIEW potential_o_donors AS (SELECT * FROM PATIENTS WHERE BLOODTYPE LIKE 'O%');
SELECT * FROM POTENTIAL_O_DONORS;

UPDATE PATIENTS SET ALLERGIES='latex' WHERE P_ID=2;

SELECT P_FNAME,ALLERGIES, BLOODTYPE FROM PATIENTS;
CREATE VIEW potential_B_donors AS (SELECT * FROM PATIENTS WHERE BLOODTYPE LIKE 'B%');
SELECT * FROM POTENTIAL_B_DONORS;

CREATE VIEW potential_AB_donors AS (SELECT * FROM PATIENTS WHERE (BLOODTYPE LIKE 'A%' OR BLOODTYPE LIKE 'B%'));
SELECT * FROM POTENTIAL_AB_DONORS;

CREATE VIEW has_allergy AS (SELECT * FROM PATIENTS WHERE ALLERGIES IS NOT NULL);
